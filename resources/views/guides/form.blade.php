...
<div class="pl-lg-4">
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                <label class="form-control-label" for="name">Nombre del guía</label>
                <input type="text" id="name" name="name" class="form-control form-control-alternative"
                    placeholder="Ingresar nombre del guía" value="{{ old('name', $guides->name ?? '') }}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                <label class="form-control-label" for="email">Correo electrónico del guía</label>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="experience" name="experience" class="form-control form-control-alternative"
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                <label class="form-control-label" for="language">Lenguaje</label>
                <input type="text" id="language" name="language" class="form-control form-control-alternative"
                    placeholder="Ingresar lenguaje" value="{{ old('language', $guides->language ?? '') }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="number" id="age" name="age" class="form-control form-control-alternative"
                    placeholder="Ingresar edad" value="{{ old('age', $guides->age ?? '') }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select name="gender" id="gender" class="form-control">
                    <option value="" disabled {{ old('gender', $guides->gender ?? '') == '' ? 'selected' : '' }}>Seleccione su género</option>
